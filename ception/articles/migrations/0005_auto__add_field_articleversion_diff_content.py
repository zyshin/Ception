...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'ArticleVersion.diff_content'
        db.add_column(u'articles_articleversion', 'diff_content',
                      self.gf('django.db.models.fields.TextField')(max_length=60000, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ArticleVersion.diff_content'
        db.delete_column(u'articles_articleversion', 'diff_content')
    ...
    models = {
        ...
        u'articles.articleversion': {
            ...
            'content': ('django.db.models.fields.TextField', [], {'max_length': '60000'}),
            'diff_content': (
            'django.db.models.fields.TextField', [], {'max_length': '60000', 'null': 'True', 'blank': 'True'}),
